...
Do NOT start Part II until you can answer these ten in under 30 seconds each without looking anything up. If you miss more than two, go finish [Part I](#java-data-structures-a-visual-toolkit) first.
...
> [key] **Score interpretation** — 9-10: skip Part I, start Part II. 6-8: skim Part I, focus on gaps. ≤ 5: read Part I fully before Part II.
...
| **Mock (Sat)** | 60 min | Full mock — think aloud, clarify, brute force → optimize → code → verify. Grade yourself with the [interview playbook](#the-interview-playbook). |

Sundays are for rest. Retention needs sleep, not extra grinding.

> [key] **The 30% rule** — At least 30% of your weekly hours must go to **problems you've already solved once**. Fresh problems feel productive; **re-solving is where mastery is built**. If you skip re-solving, you'll forget every pattern within 3 weeks of the interview.
...
- **Friday**: Grade all three mocks against the [interview playbook rubric](#the-interview-playbook). Fix your weakest phase.
...
> [pat] **Anti-pattern to avoid** — Grinding 500 LeetCode problems without a plan. Volume without spacing doesn't build recognition. **60 canonical problems drilled 3× each** beats 500 problems solved once. That's the entire premise of this book.
