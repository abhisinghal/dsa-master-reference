...
**The one thing that changes vs the flagship for this pattern:** the graph is implicit — every pair of points is an edge weighted by Manhattan distance
...
1. **Read the pattern chapter's `Min Cost to Connect All Points` section** — brute force, Java code, and Execution Trace are already there.
