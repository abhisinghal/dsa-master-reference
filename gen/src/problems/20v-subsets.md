...
**The one thing that changes vs the flagship for this pattern:** loop masks `0 .. 2ⁿ-1`; bit `i` set means element `i` is included
...
1. **Read the pattern chapter's `Subsets` section** — brute force, Java code, and Execution Trace are already there.
