# Dynamic Programming — Coin Change (min coins)

*[↗ LeetCode: Coin Change (min coins)](https://leetcode.com/problems/coin-change/)* · <span class="diff diff-m">Medium</span> · [pattern chapter →](/patterns/dp)

**The one thing that changes vs the flagship for this pattern:** unbounded items → loop capacity **upward**, take `min(dp[w], dp[w-coin]+1)`
...
1. **Read the pattern chapter's `Coin Change (min coins)` section** — brute force, Java code, and Execution Trace are already there.
