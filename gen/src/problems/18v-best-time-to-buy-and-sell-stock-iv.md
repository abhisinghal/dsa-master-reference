# Dynamic Programming — Best Time with at most k Transactions

*[↗ LeetCode: Best Time with at most k Transactions](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-iv/)* · <span class="diff diff-m">Medium</span> · [pattern chapter →](/patterns/dp)

**The one thing that changes vs the flagship for this pattern:** add a transaction-count dimension to the state
...
1. **Read the pattern chapter's `Best Time with at most k Transactions` section** — brute force, Java code, and Execution Trace are already there.
