...
*[↗ LeetCode: Maximum Average Subarray I](https://leetcode.com/problems/maximum-average-subarray-i/)* · <span class="diff diff-m">Medium</span> · [pattern chapter →](/patterns/sliding-window)

**The one thing that changes vs the flagship for this pattern:** plain sum, divide by k at the end
...
1. **Read the pattern chapter's `Maximum Average Subarray I` section** — brute force, Java code, and Execution Trace are already there.
