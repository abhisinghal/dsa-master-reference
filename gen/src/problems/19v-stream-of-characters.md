...
*[↗ LeetCode: Stream of Characters](https://leetcode.com/problems/stream-of-characters/)* · <span class="diff diff-m">Medium</span> · [pattern chapter →](/patterns/trie-pattern)

**The one thing that changes vs the flagship for this pattern:** store words *reversed* in a trie and match the incoming stream from the back
...
1. **Read the pattern chapter's `Stream of Characters` section** — brute force, Java code, and Execution Trace are already there.
