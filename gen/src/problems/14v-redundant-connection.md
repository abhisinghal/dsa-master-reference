...
**The one thing that changes vs the flagship for this pattern:** the answer is the first edge whose two endpoints are *already* connected
...
1. **Read the pattern chapter's `Redundant Connection` section** — brute force, Java code, and Execution Trace are already there.
