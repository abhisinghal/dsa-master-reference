...
*[↗ LeetCode: Jump Game I](https://leetcode.com/problems/jump-game/)* · <span class="diff diff-m">Medium</span> · [pattern chapter →](/patterns/greedy)

**The one thing that changes vs the flagship for this pattern:** just track the farthest reachable index; return whether it reaches the end
...
1. **Read the pattern chapter's `Jump Game I` section** — brute force, Java code, and Execution Trace are already there.
