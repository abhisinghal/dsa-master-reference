...
*[↗ LeetCode: Maximum Subarray (Kadane)](https://leetcode.com/problems/maximum-subarray/)* · <span class="diff diff-m">Medium</span> · [pattern chapter →](/patterns/greedy)

**The one thing that changes vs the flagship for this pattern:** reset the running sum to 0 whenever it goes negative
...
1. **Read the pattern chapter's `Maximum Subarray (Kadane)` section** — brute force, Java code, and Execution Trace are already there.
