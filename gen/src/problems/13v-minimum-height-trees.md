...
**The one thing that changes vs the flagship for this pattern:** Peel leaves layer by layer on an undirected tree; this is Kahn-shaped but not true directed topo sort.
...
1. **Read the pattern chapter's `Minimum Height Trees` section** — brute force, Java code, and Execution Trace are already there.
