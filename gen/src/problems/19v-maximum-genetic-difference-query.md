...
*[↗ LeetCode: Maximum Genetic Difference Query](https://leetcode.com/problems/maximum-genetic-difference-query/)* · <span class="diff diff-m">Medium</span> · [pattern chapter →](/patterns/trie-pattern)

**The one thing that changes vs the flagship for this pattern:** add/remove ancestors in a binary trie during tree DFS
...
1. **Read the pattern chapter's `Maximum Genetic Difference Query` section** — brute force, Java code, and Execution Trace are already there.
