...
> [key] **How to use it** — attempt each problem from its pattern card first. If you stall, read only the Approach cell (2–3 lines). The 40+ hardest variations have a full numbered-steps walkthrough below the tables.

**316** practice / variation problems indexed across **31** pattern areas — this is the one place to check when you want a hint. For the full write-up on a *canonical* problem, use the [Master Problem Index](#master-problem-index-tracker) to jump straight to its section.
...
## [Fast / Slow Pointers](#fast-slow-pointers-floyd)
...
## [Prefix Sum / Difference Array](#prefix-sum-difference-arrays)
...
## [Binary Search](#binary-search-search-on-answer)
...
## [Heaps (DS)](#heaps-priority-queues)
...
## [Segment Tree & Fenwick](#segment-tree-fenwick-tree)
...
### Contiguous Array (equal 0s and 1s) {: #contiguous-array }
...
### Fruits into Baskets {: #fruit-into-baskets }
...
### Shuffle an Array (Fisher–Yates) {: #shuffle-an-array }
