...
*[↗ LeetCode: Palindrome Partitioning II](https://leetcode.com/problems/palindrome-partitioning-ii/)* · <span class="diff diff-m">Medium</span> · [pattern chapter →](/patterns/dp)

**The one thing that changes vs the flagship for this pattern:** min cuts via an interval palindrome table
...
1. **Read the pattern chapter's `Palindrome Partitioning II` section** — brute force, Java code, and Execution Trace are already there.
