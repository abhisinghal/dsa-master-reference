# Greedy — Video Stitching / Minimum Number of Taps

*[↗ LeetCode: Video Stitching / Minimum Number of Taps](https://leetcode.com/problems/video-stitching/)* · <span class="diff diff-m">Medium</span> · [pattern chapter →](/patterns/greedy)

**The one thing that changes vs the flagship for this pattern:** the same "cover the line in fewest intervals" farthest-reach greedy
...
1. **Read the pattern chapter's `Video Stitching / Minimum Number of Taps` section** — brute force, Java code, and Execution Trace are already there.
