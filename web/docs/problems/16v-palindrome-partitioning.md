...
**The one thing that changes vs the flagship for this pattern:** a "choice" is a prefix that happens to be a palindrome; recurse on the rest
...
1. **Read the pattern chapter's `Palindrome Partitioning` section** — brute force, Java code, and Execution Trace are already there.
