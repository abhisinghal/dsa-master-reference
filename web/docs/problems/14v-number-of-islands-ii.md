...
*[↗ LeetCode: Number of Islands II](https://leetcode.com/problems/number-of-islands-ii/)* · <span class="diff diff-m">Medium</span> · [pattern chapter →](/patterns/union-find)

**The one thing that changes vs the flagship for this pattern:** online — union each newly added land cell with its neighbours, tracking the component count
...
1. **Read the pattern chapter's `Number of Islands II` section** — brute force, Java code, and Execution Trace are already there.
