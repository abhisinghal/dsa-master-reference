# Union-Find — Most Stones Removed

*[↗ LeetCode: Most Stones Removed](https://leetcode.com/problems/most-stones-removed-with-same-row-or-column/)* · <span class="diff diff-m">Medium</span> · [pattern chapter →](/patterns/union-find)

**The one thing that changes vs the flagship for this pattern:** union stones sharing a row or column; removable = total − components
...
1. **Read the pattern chapter's `Most Stones Removed` section** — brute force, Java code, and Execution Trace are already there.
