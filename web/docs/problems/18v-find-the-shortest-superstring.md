...
*[↗ LeetCode: Travelling Salesman](https://leetcode.com/problems/find-the-shortest-superstring/)* · <span class="diff diff-m">Medium</span> · [pattern chapter →](/patterns/dp)

**The one thing that changes vs the flagship for this pattern:** `dp[mask][i]` = cheapest route visiting `mask`, ending at `i`
...
1. **Read the pattern chapter's `Travelling Salesman` section** — brute force, Java code, and Execution Trace are already there.
